...
public class Member {
    ...
    public String toString() {
        return "Member{" + "id=" + id + ", name=" + name + ", availableFunds=" + availableFunds + ", subscriptionType=" + subscriptionType + ", pendingInvoices=" + pendingInvoices + ", authorizedPersons=" + authorizedPersons + '}';
    }
